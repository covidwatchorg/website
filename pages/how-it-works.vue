    ...
    <v-row id="how-it-works">
      ...
      <v-row id="header" :class="pageSectionClass">
        <v-col cols="12" :md="7" :sm="12">
          ...
          <div class="mt-10">
            <p>
              Covid Watch developed a way for people to send each other alerts if
              they might have been exposed to COVID-19. We use anonymous, local
              Bluetooth signals to help you take action.
            </p>
            <p>
