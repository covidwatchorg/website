...
<template>
    <div>
        ...
        <!-- these are our modularized buttons/typography options: -->

        <h1>h1: home rendered</h1>
        <h2>h2: let's test</h2>
        ...
        <Button disabled large>A disabled button</Button>
        <Button primary hero nuxt to="/support">A hero button w/ link</Button>
    </div>
</template>
